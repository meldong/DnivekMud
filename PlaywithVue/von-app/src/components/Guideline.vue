<template>
  <div class="guideline pa-6">
    <h4 class="mt-6">Guideline</h4>
    ...
    <v-container grid-list-lg>
      <v-layout row wrap>
        ...
        <v-flex xs9>
          <v-card>
            <div class="content grey lighten-4 px-6">
              <v-container>
                <div v-if="e6 == 1">
                  <h2 class="text-uppercase pb-4">Step 1: Motor Type</h2>
                  <p class="subheading">
                    Modify the value and click the button in help page will not
                    change the the actual value of the motor sizing tools!!
                  </p>
                  <p>
                    Select type of motor first in Home page. If you not sure
                    about the type of motor,please contact athk motor team
                  </p>
                ...
                <div v-if="e6 == 2">
                  <h2 class="text-uppercase pb-4">Step 2: Motion Profile</h2>
                  <h4 class="title blue--text">
                    Select type of motion profile
                  </h4>
                  <v-tabs light>
                    <v-tab>Manual</v-tab>
                    <v-tab>Upload</v-tab>
                  ...
                  <p>
                    ...
                    profile and other non-Sine profile, please use Upload
                    Profile
                  </p>
                  <h4 class="title blue--text">Upload</h4>
                  <p>
                    The Profile should be generate with System Group TIMING
                    CHART
                  </p>
                  <a
                    class="v-btn"
                  ...
                  >
                  <p>
                    In Motion Profile(PVAM), we only use the value of PVA, you
                    can ignore the M in current version
                  </p>
                  ...
                  <p>
                    You can try on the upper table. The table support direct
                    copy and paste from MS Excel
                  </p>
                ...
                <div v-if="e6 == 3">
                  <h2 class="text-uppercase pb-4">Step 3: Motor PN</h2>
                  <p class="subheading">
                  ...
                  <br />
                  <p>
                    In Standard mode, you can select the motor part number. If
                    the motor parameter is exist in database, the motor
                    parameter will auto update.
                  </p>
                  <v-autocomplete
                    :items="motorlist"
                    label="Motor P/N"
                ...
                <div v-if="e6 == 4">
                  <h2 class="text-uppercase pb-4">Step 4: Calculation</h2>
                  <p class="headline">Very simple :)</p>
                  <p>
                    Just Click the calculate button and I will do all the job
                    for you
                  </p>
                  <v-btn color="secondary" block>calculate</v-btn>
                </div>
                <div v-if="e6 == 5">
                  <h2 class="text-uppercase pb-4">Step 5: Store Result</h2>
                  <p>
                ...
                <div v-if="e6 == 6">
                  <h2 class="text-uppercase pb-4">Step 6: Store Progress</h2>
                  <p>
                    We can help you to save the progress. Each type of motor
                    will have a copy of save in your brower
                  </p>
                  <p>
                  ...
                  <br />
                  <p>
                    Click the Download Progress to Download current progress.
                  </p>
