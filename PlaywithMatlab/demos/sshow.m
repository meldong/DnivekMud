...
if strcmp(action,'startreset'),
    ...
    if strcmp(get(startHndl,'String'),getString(message('MATLAB:demos:shared:LabelStart'))),
        sshow start
    else
...
elseif strcmp(action,'info'),
    ...
    btnNumber=2;
    yPos=top-(btnNumber-1)*(btnHt+spacing);
    labelStr=getString(message('MATLAB:demos:shared:LabelNext'));
    ...
    btnNumber=4;
    yPos=top-(btnNumber-1)*(btnHt+spacing);
    labelStr=getString(message('MATLAB:demos:shared:LabelAutoPlay'));
