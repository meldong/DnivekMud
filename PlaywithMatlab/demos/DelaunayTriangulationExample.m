...
% This example shows how to create, edit, and query Delaunay triangulations
% using the delaunayTriangulation class. The Delaunay triangulation is the most
% widely used triangulation in scientific computing. The properties
% associated with the triangulation provide a basis for solving a variety
% of geometric problems. Construction of constrained Delaunay
% triangulations is also shown, together with an applications covering
% medial axis computation and mesh morphing.
...
% remove points. It is more efficient to edit a delaunayTriangulation to make minor
% modifications as opposed to recreating a new delaunayTriangulation from scratch,
...
% This example shows how to create an approximate Medial Axis of a
% polygonal domain using a constrained Delaunay triangulation. The Medial
% Axis of a polygon is defined by the locus of the center of a maximal disk
% within the polygon interior.
%%
