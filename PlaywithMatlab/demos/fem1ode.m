...
%
%   In this example, the nested function f(T,Y) returns the derivatives vector
%   for a finite element discretization of a partial differential equation.
%   The function mass(T) returns the time-dependent mass matrix M
...
%   ODESET to set the property 'Mass' to a function that evaluates M(t) and
