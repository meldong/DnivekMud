...
% This example shows that using polynomials of even modest degree to
% predict the future by extrapolating data is a risky business.
%
% This example is older than MATLAB(R).  It started as an exercise in
% "Computer Methods for Mathematical Computations", by Forsythe, Malcolm
% and Moler, published by Prentice-Hall in 1977.
%
% Now, MATLAB and Handle Graphics(R) make it much easier to vary the
