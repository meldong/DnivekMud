...
% This example shows the optimal fitting of a nonlinear function to a set
% of data.  It uses FMINSEARCH, an implementation of the Nelder-Mead
% simplex (direct search) algorithm, to minimize a nonlinear function of
% several variables.
