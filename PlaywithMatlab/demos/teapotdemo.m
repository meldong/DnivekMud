...
%#ok<*DEFNU>
    ...
    if nargin == 0  % LAUNCH GUI
        ...
        %Modify the text string to scale well with changes in
        %default uicontrol font size
        restxt = handles.text7;
        temppos = get(restxt,'pos');
        tempextent = get(restxt,'extent');
        set(restxt,'pos',[temppos(1) temppos(2) tempextent(3) tempextent(4)]);
...
% --------------------------------------------------------------------
function minicmdwin_Callback(h, eventdata, handles, varargin) 
    evalmcw(h);
    
% --------------------------------------------------------------------
function lightingmenu_Callback(h, eventdata, handles, varargin)
    n=get(h,'value');
    cmddata={'flat' 'gouraud' 'phong'};
    runcmd(['lighting ' cmddata{n} ';']);
    
% --------------------------------------------------------------------
function colormapmenu_Callback(h, eventdata, handles, varargin)
    n=get(h,'value');
    cmddata={'autumn' 'copper' 'hsv' 'winter'};
    runcmd(['colormap ' cmddata{n} ';']);

% --------------------------------------------------------------------
function materialmenu_Callback(h, eventdata, handles, varargin)
    n=get(h,'value');
    cmddata={'default' 'shiny' 'dull' 'metal'};
    runcmd(['material ' cmddata{n} ';']); 

% --------------------------------------------------------------------
function renderstylemenu_Callback(h, eventdata, handles, varargin)
    n=get(h,'value');
    fmtData = {
        { '.', 'none', 'none' };
        { 'none', '-', 'none' };
...
% --------------------------------------------------------------------
function colorbymenu_Callback(h, eventdata, handles, varargin)
    n=get(h,'value');    
    p=get(gcf,'UserData');
    s=get(p,'UserData');
...
% --------------------------------------------------------------------
function transparentbutton_Callback(h, eventdata, handles, varargin)
    if get(h,'value') == 1 
        runcmd('alpha(0.5);');
    else
        runcmd('alpha(1);');
...
% --------------------------------------------------------------------
function infobutton_Callback(h, eventdata, handles, varargin)
    helpwin(mfilename);    

% --------------------------------------------------------------------
function closebutton_Callback(h, eventdata, handles, varargin)
    close(gcf)

% --------------------------------------------------------------------
function edgebutton_Callback(h, eventdata, handles, varargin)
...
% --------------------------------------------------------------------
function bottombutton_Callback(h, eventdata, handles, varargin)
    p=get(gcf,'UserData');
    s=get(p,'UserData');    
    if get(h,'value') == 1
        s.bottom=1;
...
% --------------------------------------------------------------------
function resolutionslider_Callback(h, eventdata, handles, varargin)
    res = get(h,'value');
    p=get(gcf,'UserData');
    s=get(p,'UserData');
...
% --------------------------------------------------------------------
function lidoffsetslider_Callback(h, eventdata, handles, varargin)
    res = get(h,'value');
    p=get(gcf,'UserData');
    s=get(p,'UserData');
    s.lidoffset=res;
