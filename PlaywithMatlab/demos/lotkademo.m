...
% This example shows how to use ODE23 and ODE45 on a simple differential
% equation. ODE23 and ODE45 are functions for the numerical solution of
% ordinary differential equations.  They employ variable step size
% Runge-Kutta integration methods.  ODE23 uses a simple 2nd and 3rd order
% pair of formulas for medium accuracy and ODE45 uses a 4th and 5th order
% pair for higher accuracy.
...
% respectively.  The quadratic cross term accounts for the interactions between
...
%%
% To simulate a system, create a function that returns a column vector of
